...
const USB_Descriptor_HIDReport_Datatype_t PROGMEM KeyboardReport[] =
{
    ...
    #define HID_MOUSE_REPORT_SIZE HID_RI_REPORT_SIZE(8, 16)
    #define HID_MOUSE_LOGICAL_MINIMUM HID_RI_LOGICAL_MINIMUM(16, (0xFFFF << (MOUSE_PRECISION - 1)) + 1)
    #define HID_MOUSE_LOGICAL_MAXIMUM HID_RI_LOGICAL_MAXIMUM(16, -((0xFFFF << (MOUSE_PRECISION - 1)) + 1))
    #define HID_MOUSE_WHEEL_LOGICAL_MINIMUM HID_RI_LOGICAL_MINIMUM(16, (0xFFFF << (MOUSE_WHEEL_PRECISION - 1)) + 1)
    #define HID_MOUSE_WHEEL_LOGICAL_MAXIMUM HID_RI_LOGICAL_MAXIMUM(16, -((0xFFFF << (MOUSE_WHEEL_PRECISION - 1)) + 1))
#else
    #define HID_MOUSE_REPORT_SIZE HID_RI_REPORT_SIZE(8, 8)
    #define HID_MOUSE_LOGICAL_MINIMUM HID_RI_LOGICAL_MINIMUM(8, -127)
    #define HID_MOUSE_LOGICAL_MAXIMUM HID_RI_LOGICAL_MAXIMUM(8, 127)
    #define HID_MOUSE_WHEEL_LOGICAL_MINIMUM HID_RI_LOGICAL_MINIMUM(8, -127)
    #define HID_MOUSE_WHEEL_LOGICAL_MAXIMUM HID_RI_LOGICAL_MAXIMUM(8, 127)
#endif
