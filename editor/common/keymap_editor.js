...
var keycodes = [
    ...
    {id: 'APP ',                        name: 'Application',                 desc: 'Menu on Windows'},
    ...
    {id: 'EXECUTE',                     name: 'Execute',                     desc: 'Execute(Unix)'},
    {id: 'HELP',                        name: 'Help',                        desc: 'Help(Unix)'},
    {id: 'MENU',                        name: 'Menu',                        desc: 'Menu(Unix)'},
    {id: 'SELECT',                      name: 'Select',                      desc: 'Select(Unix)'},
    {id: 'STOP',                        name: 'Stop',                        desc: 'Stop(Unix)'},
    {id: 'AGAIN',                       name: 'Again',                       desc: 'Again(Unix)'},
    {id: 'UNDO',                        name: 'Undo',                        desc: 'Undo(Unix)'},
    {id: 'CUT',                         name: 'Cut',                         desc: 'Cut(Unix)'},
    {id: 'COPY',                        name: 'Copy',                        desc: 'Copy(Unix)'},
    {id: 'PASTE',                       name: 'Paste',                       desc: 'Paste(Unix)'},
    {id: 'FIND',                        name: 'Find',                        desc: 'Find(Unix)'},
    ...
    {id: 'INT1',                        name: 'JIS \u308D',                  desc: 'Japanese RO'},
    {id: 'INT2',                        name: '\u3072\u3089\u304c\u306a',    desc: 'Japanese Hiragana'},
    {id: 'INT3',                        name: 'JIS \uffe5',                  desc: 'Japanese Yen'},
...
/* Standard codes for 16bit Action 165-223(0xa5-df)
