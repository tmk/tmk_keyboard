 ...
 *
 * row: 0    1    2    3    4    5    6    7
 * pin: PC2  PB3  PB4  PB2  PB1  PB5  PB6  PC7
 *
 */
static void init_rows(void)
{
...
static void select_col(uint8_t col)
{
    switch (col) {
        ...
        case 2:
            ...
            break;
        case 3:
            PORTD |= (1<<6) | (1<<2) | (1<<1) | (1<<0);
            break;
        case 4:
            PORTD |= (1<<6) | (1<<1) | (1<<0);
            break;
        case 5:
            PORTD |= (1<<5) | (1<<4) | (1<<2) | (1<<1) | (1<<0);
            break;
        case 6:
            PORTD |= (1<<5) | (1<<4) | (1<<1) | (1<<0);
            break;
        case 7:
            PORTD |= (1<<5) | (1<<2) | (1<<1) | (1<<0);
            break;
        case 8:
            PORTD |= (1<<5) | (1<<1) | (1<<0);
            break;
        case 9:
            PORTD |= (1<<4) | (1<<2) | (1<<1) | (1<<0);
            break;
        case 10:
            PORTD |= (1<<4) | (1<<1) | (1<<0);
            break;
        ...
        case 12:
            ...
            break;
        case 13:
            PORTD |= (1<<6) | (1<<5) | (1<<2) | (1<<0);
            break;
        case 14:
            PORTD |= (1<<6) | (1<<5) | (1<<0);
            break;
        case 15:
            PORTD |= (1<<6) | (1<<5) | (1<<4) | (1<<2) | (1<<1);
            break;
        case 16:
            PORTD |= (1<<6) | (1<<5) | (1<<4) | (1<<1);
            break;
        case 17:
            PORTD |= (1<<6) | (1<<5) | (1<<2) | (1<<1);
            break;
    }
}
