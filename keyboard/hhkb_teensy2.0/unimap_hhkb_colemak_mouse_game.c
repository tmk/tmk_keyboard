...
// 1, HHKB, QWERTY, Game
    ...
    CAPS,M_1 ,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,DL1, DL0,      BSPC,
    CAPS,VOLD,VOLU,MUTE,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,          ENT,
    TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     TRNS,TRNS,
    ...
    CAPS,LTAB,MS_L,MS_D,MS_R,RTAB,LTAB,MS_L,MS_D,MS_R,RTAB,FRWD,          ENT,
    TRNS,     BTN4,BTN5,BTN1,BTN2,BTN3,BTN2,BTN1,BTN4,BTN5,BACK,     TRNS,TRNS,
         MYCM,NTPD,               SPC,                     CALC,MYCM ),
    [7] = UNIMAP_HHKB(
    PWR, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, INS, DEL,
    CAPS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PSCR,SLCK,PAUS,UP,  TRNS,     BSPC,
    CAPS,VOLD,VOLU,MUTE,TRNS,TRNS,PAST,PSLS,HOME,PGUP,LEFT,RGHT,          ENT,
