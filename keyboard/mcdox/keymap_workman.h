static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
     * |  Tab   |   Q  |   D  |   R  |   W  |   B  | Home |           |  [   |   J  |   F  |   U  |   P  |   ;  |   =    |
     * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
     * |  ~L1   |   A  |   S  |   H  |   T  |   G  |------|           |------|   Y  |   N  |   E  |   O  |   I  |   '    |
     * |--------+------+------+------+------+------| End  |           |  ]   |------+------+------+------+------+--------|
     * |  BkSp  |   Z  |   X  |   M  |   C  |   V  |      |           |      |   K  |   L  |   ,  |   .  |   /  | RCtrl  |
     * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
    ...
    KEYMAP(
        ...
        // right hand
             F5,  6,   7,   8,   9,   0,   MINS,
             LBRC,J,   F,   U,   P,SCLN,   EQL,
                  Y,   N,   E,   O,   I,   QUOT,
             RBRC,K,   L,COMM, DOT,SLSH,   RCTL,
     ...
     * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
     * |    =   |  ;   |  P   |  U   |  F   |  J   |      |           |      |  B   |  W   |  R   |  D   |  Q   |  Tab   |
     * |--------+------+------+------+------+------|  [   |           | Home |------+------+------+------+------+--------|
     * |    '   |  I   |  O   |  E   |  N   |  Y   |------|           |------|  G   |  T   |  H   |  S   |  A   |  ~L3   |
     * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
     * | LCtrl  |  /   |  .   |  ,   |  L   |  K   |  ]   |           | End  |  V   |  C   |  M   |  X   |  Z   |  BkSp  |
     * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
    ...
    KEYMAP(
        // left hand
      MINS,  0,   9,   8,   7,   6,  F5,
       EQL,SCLN,  P,   U,   F,   J,LBRC,
      QUOT,  I,   O,   E,   N,   Y,
     LCTRL,SLSH,DOT,COMM,   L,   K,RBRC,
