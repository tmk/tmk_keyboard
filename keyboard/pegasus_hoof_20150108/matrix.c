 ...
 *
 * row: 0    1    2    3    4    5    6    7
 * pin: PB5  PC7  PB4  PB6  PB1  PB0  PB3  PB2
 *
 */
static void init_rows(void)
{
...
static void select_col(uint8_t col)
{
    switch (col) {
        ...
        case 7:
            ...
            break;
        case 8:
            PORTD |= (1<<6) | (1<<5) | (1<<3) | (1<<0);
            break;
        case 9:
            PORTD |= (1<<6) | (1<<5) | (1<<4) | (1<<0);
            break;
        case 10:
        ...
        case 14:
            ...
            break;
        case 15:
            PORTD |= (1<<4) | (1<<3) | (1<<1) | (1<<0);
            break;
        case 16:
            PORTD |= (1<<5) | (1<<1) | (1<<0);
            break;
        case 17:
            PORTD |= (1<<5) | (1<<3) | (1<<1) | (1<<0);
            break;
    }
}
