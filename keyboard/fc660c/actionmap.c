...
#define AC_I2C      ACTION_FUNCTION(0)
...
const action_t actionmaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [3] = AMAP( \
        GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, TRNS,     I2C,  \
...
void action_function(keyrecord_t *record, uint8_t id, uint8_t opt)
{
    if (record->event.pressed) {
        ...
        // read RDAC register: mine replied 0x27
        print("RDAC: ");
        i2c_start(AD5258_WR);
...
/*
        ...
        // read EEPROM register: mine replied 0x27
        print("EEPROM: ");
        i2c_start(AD5258_WR);
        ...
        // read tolernace register: mine replied 0x27
        print("RDAC: ");
        i2c_start(AD5258_WR);
