...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
     ...
     * `-------------------------------------------------------------|`-----------'|---------------|
     *     |Kana|Gui|Alt|MHEN|       Space              |HENK|Gui|App|  | Down  |  |  0|  ,|  .| ^1|
     *     `---------------------------------------------------------'  `-------'  `---------------'
    ...
    LSFT,     Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH, RO,      RSFT,LEFT,MUTE,RGHT,P1,  P2,  P3,  PEQL,
         KANA,LGUI,LALT,MHEN,        SPC,                        HENK,RGUI,APP,     DOWN,     P0,  PCMM,PDOT
    ),
};
