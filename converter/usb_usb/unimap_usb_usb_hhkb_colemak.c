...
//0, HHKB, Colemak
    ...
    LSFT,NUBS,Z,   X,   C,   V,   B,   K,   M,   COMM,DOT, SLS7,     RO,  RSFT,          UP,           P1,  P2,  P3,  PENT,
    LCTL,L7  ,LALT,MHEN,          SPC7,          HENK,KANA,RALT,RGUI,L6,  L6,       LEFT,DOWN,RGHT,    P0,       PDOT,PEQL
    ),
//1, HHKB & ThinkPad, QWERTY
    UNIMAP(
              F13, F14, F15, F16, F17, F18, F19, F20, F21, F22, F23, F24,
    ESC,      F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12,           RGUI,SLCK,PAUS,         VOLD,VOLU,MUTE,
    GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, JYEN,BSPC,     INS, HOME,PGUP,    NLCK,PSLS,PAST,PMNS,
    ...
    LSFT,NUBS,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLS7,     RO,  RSFT,          UP,           P1,  P2,  P3,  PENT,
    LCTL,LGUI,LALT,MHEN,          SPC7,          HENK,KANA,RALT,RGUI,L6,  L6,       LEFT,DOWN,RGHT,    P0,       PDOT,PEQL
    ),
//2, ThinkPad, Colemak
    UNIMAP(
              F13, F14, F15, F16, F17, F18, F19, F20, F21, F22, F23, F24,
    ...
    LSFT,NUBS,Z,   X,   C,   V,   B,   K,   M,   COMM,DOT, SLS7,     RO,  RSFT,          UP,           P1,  P2,  P3,  PENT,
    CAPS,LGUI,LALT,MHEN,          SPC7,          HENK,KANA,RALT,RGUI,L6,  L6,       LEFT,DOWN,RGHT,    P0,       PDOT,PEQL
    ),
//3, TRNS
    UNIMAP(
