...
//1, HHKB & ThinkPad, QWERTY
    ...
    LCTL,LGUI,LALT,MHEN,          SPC6,          HENK,KANA,RALT,RGUI,L7,  L7,       LEFT,DOWN,RGHT,    P0,       PDOT,PEQL
    ),
//2, ThinkPad, Colemak
    UNIMAP(
              F13, F14, F15, F16, F17, F18, F19, F20, F21, F22, F23, F24,
    ...
    LSFT,NUBS,Z,   X,   C,   V,   B,   K,   M,   COMM,DOT, SLSH,     RO,  RSFT,          UP,           P1,  P2,  P3,  PENT,
    CAPS,LGUI,LALT,MHEN,          SPC6,          HENK,KANA,RALT,RGUI,L7,  L7,       LEFT,DOWN,RGHT,    P0,       PDOT,PEQL
    ),
//3, TRNS
    UNIMAP(
